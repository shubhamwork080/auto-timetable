...
class Subject
{
    ...
    public $subjectteacher2; 
    public $subjectteacher3; 
}
...
period4='" . $subjectslots[$i][$j][2] . "<br>" . $aliasslots[$i][$j][2][0] . "',
...
period4='" . $teachers[$i]->days[1][$j][2] . "<br>" . $teachers[$i]->classroom_names[1][$j][2] . "',
