...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    ...
    <!-- Wrapper for slides -->
    <div class="carousel-inner"style="box-shadow: 5px 5px 20px black" role="listbox">
        <div class="item active">
            <img src="assets/img/pic1.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/pic2.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/lab3.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/lab4.jpg" alt="Chania">
        </div>
    </div>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4><strong>Email: </strong>schedully@gamil.com</h4>
            </div>
